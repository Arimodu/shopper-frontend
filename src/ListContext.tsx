...
export const fetchListById = async (listId: string): Promise<List> => {
  console.log("Fetching list for listId:", listId);
  await new Promise((resolve) => setTimeout(resolve, 1000 * Math.random())); // Simulate API delay
